...
@section('content')
    {!! Form::open(["action"=>"VisitorsController@store","method"=>"POST","enctype"=>"multpart/form-data",'files'=> true,"id"=>"visitor_form","data-parsley-validate"=>""]) !!}
    ...
    <div class="form-group">
        {!! Form::text('text','',["class"=>"form-control","id"=>"number","placeholder"=>"0758522463","required"=>"","data-parsley-type"=>"number","data-parsley-maxlength"=>"10"]) !!}
    </div>
    <div class="form-group">

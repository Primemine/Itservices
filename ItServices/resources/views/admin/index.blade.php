        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="row">
                 ...
                 {{visits('App\Servirce')->period('day')->top(10)}}
                  <small>%</small>
                </span>
                            </div>
                            <!-- /.info-box-content -->
                    ...
                    <div class="col-12 col-sm-6 col-md-3">
                        <div class="info-box mb-3">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number">{{visits('App\Post')->count()}}</span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                        <!-- /.info-box -->
                                    ...
                                    <div class="card-body p-0">
                                        <ul class="users-list clearfix">
                                            @foreach(\App\User::orderBy('created_at','desc')->take(8)->get() as $user)
                                                <li>
                                                    <img src="{{asset('/storage/net/user.png')}}" alt="User Image">
                                                    <a class="users-list-name" href="#">{{$user->email}}</a>
                                ...
                                <ul class="products-list product-list-in-card pl-2 pr-2">
                                        ...
                                        <li class="item">
                                            <div class="product-img">
                                                <img src="{{asset('/storage/net/'.$post->image)}}" alt="Product Image" class="img-size-50">
                                            </div>
                                            <div class="product-info">
                                                <a href="javascript:void(0)" class="product-title">{{$post->post_name}}</a>
                                            </div>
                                        </li>
                                        <!-- /.item -->
                                         @endforeach
